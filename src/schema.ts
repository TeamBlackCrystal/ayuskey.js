...
export interface User {
	...
	isCat: boolean
	isLady: boolean
	emojis: { name: string; host: string; url: string; aliases: string }
	url: string
	createdAt: string
	updatedAt: string
	bannerUrl: string
...
export interface DriveFile {
	...
	isSensitive: boolean
	blurhash: string
	properties: { width: number; height: number; avgColor: string }
	url: string
	thumbnailUrl: string
	comment: string
	folderId: string
...
export interface ReversiGame {
	...
	loopedBoard: boolean
	logs: { at: string; color: boolean; pos: number }
	map: string
}

export interface ReversiMatching {
	id: string
	createdAt: string
	parentId: string
	parent: User
